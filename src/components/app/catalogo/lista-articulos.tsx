...
import { PaqueteArticulosListaCatalogo } from "@/types/catalogo";
import { ArrowRightIcon, Star } from "lucide-react";
import Link from "next/link";

export default function ListaArticulosCatalogoPreview({
  lista,
}: {
  lista: PaqueteArticulosListaCatalogo[];
}) {
  return (
    <div>
      <div className="flex justify-between items-center flex-wrap mb-6">
        ...
        <Button variant="outline" className="mt-4 md:mt-0">
          <Link href="/app/catalogo/articulos" className="flex items-center">
            Ver todos
